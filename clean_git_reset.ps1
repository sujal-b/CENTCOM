# 1. Wipe out existing git history completely
if (Test-Path .git) {
...
# 3. Set local config to sujal-b ONLY for this specific repo
git config user.name "sujal-b"
git config user.email "sujal-b@users.noreply.github.com"

# 4. Create the granular commits
...
git add .
git commit -m "feat: finalize CENTCOM architecture, removing legacy CesiumJS dependency"
